...
public class OpenIDTokenProvider extends AuthorizationCodeAccessTokenProvider {
    ...
    private final IdTokenToOAuthAdditionalInfo idTokenToOAuthInfoConverter;
    ...
    @Autowired
    public OpenIDTokenProvider(IdTokenToOAuthAdditionalInfo idTokenToOAuthInfoConverter) {
    ...
    public OAuth2AccessToken obtainAccessToken(OAuth2ProtectedResourceDetails details, AccessTokenRequest request)
        ...
        OAuthAdditionalInfo additionalInfo = idTokenToOAuthInfoConverter.translateToken((String)additionalInfoMap.get("id_token"));
